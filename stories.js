...
['Κάποιος που ξέρεις έχει κανονίσει να βγει. Ο σύντροφός του προτιμά να μείνουν σπίτι.','A friend has made plans to go out. Their partner would rather stay in.'],
...
['Τι αλλάζει όταν μια επιθυμία γίνεται απειλή; Σκέψου αν αυτός ο άνθρωπος μπορεί να επιλέξει χωρίς φόβο.','What changes when a wish becomes a threat? Think about whether your friend can choose without fear.']),
story('physical-force',['Χωρίς σημάδι','Without a mark'],[
['Κάποιος που ξέρεις σου περιγράφει έναν καβγά στο σπίτι.','A friend tells you about an argument at home.'],
['Κάποιος τον έσπρωξε στον τοίχο. Μετά είπε: «Δεν έπαθες και τίποτα».','Someone shoved them against a wall. Afterwards they said: “You’re not even hurt.”'],
...
['Δεν χρειάζεται να υπάρχει ορατό σημάδι για να πάρεις στα σοβαρά αυτό που περιγράφει κάποιος που ξέρεις.','You do not need to see a mark to take what your friend describes seriously.']),
...
['Κάποιος που ξέρεις έχει ζητήσει από το πρώην ταίρι του να σταματήσει να επικοινωνεί.','A friend has asked their ex-partner to stop contacting them.'],
...
['Το ότι μια σχέση τελείωσε δεν σημαίνει ότι ο φόβος τελείωσε. Πώς θα έδειχνες σε αυτόν τον άνθρωπο ότι τον ακούς;','A relationship ending does not mean the fear has ended. What could help your friend feel heard?']),
...
['Κάποιος από τη σχολή απειλεί διαδικτυακά έναν γνωστό σου.','Someone from college threatens a friend online.'],
...
['Πριν αναζητήσεις μια ετικέτα, άκου τι συμβαίνει και τι χρειάζεται αυτός ο άνθρωπος.','Before looking for a label, listen to what is happening and what that person needs.']),
